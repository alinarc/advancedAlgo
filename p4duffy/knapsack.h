...
float knapsack::bound()
{
      ...
      while (theCost != costLimit)
      {
            ...
            //if adding the full item is possible
            {
                  ...
                  cout<<endl<<"The Cost is:"<<theCost<<" the Value is:"<<theValue<<endl<<"The Used indeces are: "; 
                  for (int i=0; i <=numUsed;i++)
                  {
                        cout<<usedIndeces.at(i)<<" ";
                  }
            }
